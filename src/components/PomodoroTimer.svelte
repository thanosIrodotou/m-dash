...
<style>
    ...
    .inProgress progress[value]::-webkit-progress-value {
        background-image: -webkit-linear-gradient(180deg, transparent 100%, rgba(0, 0, 0, 0) 33%, rgba(0, 0, 0, 0) 66%, transparent 66%), -webkit-linear-gradient(top, rgba(255, 255, 255, 0), rgba(0, 0, 0, 0)), -webkit-linear-gradient(left, #09c, #f44);
        background-color: rgba(0, 0, 0, 0);
    ...
    .inProgress progress[value]::-moz-progress-bar {
        background-image: -moz-linear-gradient(180deg, transparent 100%, rgba(0, 0, 0, 0) 33%, rgba(0, 0, 0, 0) 66%, transparent 66%), -moz-linear-gradient(top, rgba(255, 255, 255, 0), rgba(0, 0, 0, 0)), -moz-linear-gradient(left, #09c, #f44);
        background-color: rgba(0, 0, 0, 0);
        background-size: 35px 20px, 100% 100%, 100% 100%;
        box-sizing: border-box;
        border-radius: 4px;
    ...
    .inRest progress[value]::-webkit-progress-value {
        background-image: -webkit-linear-gradient(180deg, transparent 100%, rgba(0, 0, 0, 0) 33%, rgba(0, 0, 0, 0) 66%, transparent 66%), -webkit-linear-gradient(top, rgba(255, 255, 255, 0), rgba(0, 0, 0, 0)), -webkit-linear-gradient(left, #09c, #44ff9e);
        background-color: rgba(0, 0, 0, 0);
        background-size: 35px 20px, 100% 100%, 100% 100%;
        box-sizing: border-box;
        border-radius: 4px;
    ...
    .inRest progress[value]::-moz-progress-bar {
        background-image: -moz-linear-gradient(180deg, transparent 100%, rgba(0, 0, 0, 0) 33%, rgba(0, 0, 0, 0) 66%, transparent 66%), -moz-linear-gradient(top, rgba(255, 255, 255, 0), rgba(0, 0, 0, 0)), -moz-linear-gradient(left, #09c, #44ff9e);
        background-color: rgba(0, 0, 0, 0);
        background-size: 35px 20px, 100% 100%, 100% 100%;
        box-sizing: border-box;
        border-radius: 4px;
...
<svelte:window on:beforeunload={count.set({timer: pomodoroTime || 1500, rest: restTime || 300})} on:keydown={handleKeyPress} />

<section>
    <time>
        <div class="tooltip">
            <button class="reset slide" disabled={(currentState===State.inProgress && currentState===State.resting) &&
                currentState !==State.paused} on:click={cancelPomodoro}>
            </button>
        ...
        <button class="paused" on:click={pausePomodoro} disabled={(currentState !==State.inProgress && currentState
            !==State.resting)}>
            pause
        </button>
        <div class="tooltip">
...
{#if (pomodoroTime <=1500 && currentState !== State.resting) && previousState !== State.resting}
    <div class="inProgress">
        <progress id="pomodoroProgress" class="fade-in" max="100" value={100 - (pomodoroTime / 1500) * 100}></progress>
    </div>
{/if} {#if currentState === State.resting || previousState === State.resting}
    <div class="inRest">
